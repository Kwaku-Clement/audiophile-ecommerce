  ...
  <div class="category-page">
    ...
    <section class="bg-black text-white py-20">
      <div class="container mx-auto px-4 text-center">
        <h1 class="text-4xl font-bold">EARPHONES</h1>
      </div>
    </section>
...
const products = computed(() => {
  return allProducts.value?.filter(product => product.category === 'earphones') || []
})
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Discover our collection of premium earphones for portable audio excellence.' }
  ]
})
</script>
